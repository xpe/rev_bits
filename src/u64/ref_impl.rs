...
pub fn reverse_u64(input: u64, range: impl RangeBounds<u32>) -> u64 {
...
fn to_array(mut input: u64) -> [bool; N] {
...
mod tests {
    ...
    fn reverse_u32_ex2() {
        let x = 0xaaaaaaaa;
        let y = 0xaaaaa55a;
        assert_eq!(reverse_u64(x, 4..12), y);
    }
    ...
    fn reverse_u32_ex3() {
        let x = 0xaaaaaaaa;
        let y = 0x55555aaa;
        assert_eq!(reverse_u64(x, 12..32), y);
    }

    #[quickcheck]
    fn reverse_u64_reverse_u64(x: u64, range: Range<u32>) -> bool {
        x == reverse_u64(reverse_u64(x, range.clone()), range)
    }

    #[quickcheck]
    fn to_array_to_u32(x: u64) -> bool {
        x == to_u64(&to_array(x))
    }
}
